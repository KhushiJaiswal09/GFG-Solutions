<h2><a href="https://www.geeksforgeeks.org/problems/edit-distance3702/1?page=1&difficulty=Basic,Hard&sortBy=submissions">Edit Distance</a></h2><h3>Difficulty Level : Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two strings <strong>s</strong>&nbsp;and <strong>t. </strong>Return the minimum number of operations required to convert <strong>s&nbsp;</strong>to <strong>t</strong>.<br>
