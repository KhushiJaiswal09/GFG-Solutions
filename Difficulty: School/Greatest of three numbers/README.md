<h2><a href="https://www.geeksforgeeks.org/problems/greatest-of-three-numbers2520/1?page=1&difficulty=School&status=unsolved,attempted&sortBy=submissions">Greatest of three numbers</a></h2><h3>Difficulty Level : Difficulty: School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given 3 numbers A, B and C. Find the greatest number among them.</span></p>
